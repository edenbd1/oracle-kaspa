...
async function main() {
  console.log('=== Kaspa LIVE Transaction Smoke Test ===\n');
  console.log('WARNING: This will submit a real transaction to testnet!\n');
  ...
  try {
    ...
    const testPayload: AnchorPayload = {
      d: 0.0001,
      h: Date.now().toString(16).slice(0, 16).padEnd(16, '0'), // 16-char hash
      n: 2,
      p: 97500.00,
    };
    ...
    for (const pending of transactions) {
      ...
      console.log(`  Explorer: https://explorer-tn11.kaspa.org/txs/${txId}`);
    }
